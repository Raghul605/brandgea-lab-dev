  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-[#090d16] to-[#0f172a] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden">
      ...
      <div className="z-10">
        {/* Top badge */}
        <div className="mb-2 ">
          <span className="text-xs uppercase tracking-widest text-gray-400 px-3 py-1 border border-blue-300 hover: rounded-full shadow-[0_0_25px_6px_rgba(76,49,251,0.3)] cursor-pointer">
            Powered by AI
          </span>
        </div>
        ...
        <p className="text-gray-400 mt-4 max-w-xl mx-auto">
          Instant price estimates for your custom apparel designs. Save time,
          budget smarter, and bring your ideas to life with confidence.
        </p>
