...
export default function Vendors() {
    ...
    const fetchVendors = async () => {
      try {
        ...
        const msg =
          ...
          "Failed to load vendors. Please retry.";
        setError(msg);
      } finally {
        setLoading(false);
      }
  ...
  const filtered = useMemo(() => {
    ...
    return vendors.filter((v) => {
      ...
      const phone = (v.VendorPhone || "").toLowerCase();
      return (
        name.includes(term) ||
        email.includes(term) ||
        phone.includes(term)
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">
              All onboarded manufacturers / vendors for Brandgea Lab.
            </p>
          </div>
          ...
          <div className="mt-2 overflow-x-auto rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                {paginated.map((v) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() =>
                        navigate(`/dashboard/vendors/${v._id}`)
                      }
                    >
            ...
            <div className="flex items-center justify-between px-4 py-2 border-t border-gray-100">
              <p className="text-[11px] text-gray-400">
                Showing {paginated.length} of {filtered.length} vendor(s).
              </p>
